...
def compute_score(setting_name, load_saved=False):
    """ Compute scores on BurstSR validation set. If load_saved is true, the script will use pre-computed
    ...
    for n in network_list:
        ...
        for idx in tqdm.tqdm(range(len(dataset))):
            ...
            with torch.no_grad():
                net_pred_warped_m, valid = sca_module(net_pred, gt, burst)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Compute scores on BurstSR validation set. If load_saved is true, '
                                                 'the script will use pre-computed images whenever available. '
